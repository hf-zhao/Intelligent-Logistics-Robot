...
theta1 = atan2d(py, px)
% theta3求解(1,4)(3,4)
m = px * cosd(theta1) + py * sind(theta1) - a1 + a4 * az - d5 * (ax * cosd(theta1) + ay * sind(theta1));
n = pz + d5 * az - a4 * (ax * cosd(theta1) + ay * sind(theta1));
theta3_1 = acosd(m^2 + n^2 - a3^2 -a2^2) / (2 * a2 * a3)
theta3_2 = -theta3_1
